...
# Agora sim podemos usar st.markdown
st.markdown("""
<style>
    .stApp {
...
SETORES = ["GENTE", "SEGURANÇA", "ENTREGA", "FINANCEIRO", "FROTA", "GESTÃO", "AJUDANTE", "OPERADOR"]
ICONES = {"GENTE": "👥", "SEGURANÇA": "🛡️", "ENTREGA": "🚚", "FINANCEIRO": "💰", "FROTA": "🚛", "GESTÃO": "📊", "AJUDANTE": "📦", "OPERADOR": "🔧"}
...
def criar_card(nome):
    with st.container(border=True):
        ...
        try:
            ...
            st.markdown(f"<div style='width:{logo_width}px;height:{logo_width}px;background:white;border-radius:50%;margin:0 auto;display:flex;align-items:center;justify-content:center'><span style='font-size:50px'>🏢</span></div>", unsafe_allow_html=True)
